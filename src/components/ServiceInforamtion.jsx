...
const documentDetails = {
  1: {
    title: "",
    description: `All foreign-language documents must be submitted as certified copies. These certified copies must be accompanied by original translations by a translator.`,
  },
  2: {
    title: "",
    description: `All foreign documents must be presented with a Hague Apostille or be legalized by the German embassy in the issuing country. Information on legalization can be found at:`,
  },
  3: {
    title: "",
...
export default function ServiceInforamtion() {
  ...
  return (
    <div className="pb-[100px] bg-[#ffffff]">
      ...
      {/* Section Title */}
      <h1 className="text-center pt-[40px] text-[#002F6C] pb-[50px] ml-[10px] font-poppins font-bold text-[28px] leading-relaxed md:text-[32px] lg:text-[36px] lg:ml-[20px]">
        Document
      </h1>
